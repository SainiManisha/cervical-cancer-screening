...
experiments = [
    lambda: generic_train.train_on_cervix(
        vgginnet_builder,
        "./cervix/vggin-net-wo-pre-trained-from-scratch-1",
    ...
    lambda: generic_train.train_on_cervix(
        vgg_model_fn,
        "./cervix/vgg16-wo-pre-trained-from-scratch-1",
        tf.keras.applications.vgg16.preprocess_input,
        augment=True,
        reject_resample=True,
    ),
    lambda: generic_train.train_on_cervix(
        ...
        "./cervix/inception_v3-wo-pre-trained-from-scratch-1",
    ...
    lambda: generic_train.train_on_cervix(
        ...
        "./cervix/resnet50-wo-pre-trained-from-scratch-1",
    ...
    lambda: generic_train.train_on_cervix(
        ...
        "./cervix/efficientnet-b0-wo-pre-trained-from-scratch-1",
    ...
    lambda: generic_train.train_on_cervix(
        ...
        "./cervix/resnet50v2-wo-pre-trained-from-scratch-1",
